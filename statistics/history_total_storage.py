...
class HistoryTotalStorageCounter(object):
    ...
    def start_count(self):
        ...
        commits_obj_store = self.objstore_factory.get_obj_store('commits')
        fs_obj_store = self.objstore_factory.get_obj_store('fs')
        ...
        for repo_id in repo_ids:
            ...
            try:
                q = self.edb_session.query(HistoryTotalStorageStat).filter(HistoryTotalStorageStat.timestamp==timestamp,
                                                                           HistoryTotalStorageStat.repo_id==repo_id)
            except Exception as e:
