...
def _get_user_activities(session, username, op_user, start, limit):
    if start < 0:
...
def get_user_activities(session, username, op_user, start, limit):
    return _get_user_activities(session, username, op_user, start, limit)
